...
/**
 * print_str - Print a given staring
 * @str: String to print
 */
...
/**
 * rev_string - Reverse the given sring
 * @s: String to reverse
...
/**
 * str_len - Find the lenght of a given string
 * @str: String to find lenght of
...
/**
 * int - Initialize an array with 0
 * @arr: The array to intialize
 ...
 * @len1: The lenght of the first string
 * @len2: The lenght of the second string
 * Return: Pointer to char array
 */

cjar *mul(char *num1, char *num2, int len1, int len2)
{
...
/**
 * check_zero - Check to see if the number is zero or if zero need to be gone
 * @str: String to check for zeroes
 * @len: Lenght of string
 * Return: Pointer to new number string
 */
...
/**
 * main - Run all necessary functions to multiply two strings as numbers
 * @argc: Number of args
 * @argv: Value of args
 * Return: 0 on success
 */
